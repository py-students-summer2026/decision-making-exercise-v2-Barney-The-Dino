...
def get_discount():
    ...
    """
    #### write your solution for this function below here. ####
    num_masks = int(input("Enter the number of masks you would like: "))
    cost_per_mask = 5
    total_cost = num_masks * cost_per_mask
    if num_masks >= 5000:
        total_cost *= 0.8  # apply 20% discount
    total_cost = round(total_cost)  # round to the nearest integer
    return f"${total_cost:,}"  # format with commas
